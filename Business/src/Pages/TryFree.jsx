...
const TryFree = () => {
    ...
    return (
        <div className="tryfree-container">
            <div className="tryfree-header">
            <div className="prefix">Booka gratis möte</div>
                <h1>Kom igång kostnadsfritt!</h1>
                
            </div>

            <div className="tryfree-info">
                <h1>Kom i kontakt med oss!</h1>
                 <p>Fyll i dina uppgifter så kontaktar vi dig för att boka in ett möte!<br />
                    </p>
            </div>

            <form className="tryfree-form" onSubmit={handleSubmit} noValidate>
